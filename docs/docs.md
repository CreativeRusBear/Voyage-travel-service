...
<p>Если пользователь введет неправильный логин или пароль в окне авторизации, то программа сообщит ему об этом (Рис.81). В таком случае пользователю нужно лишь заново ввести свои данные корректно и начать работу с самой программой. </p>
